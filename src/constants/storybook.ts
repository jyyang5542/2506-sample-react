export const ARG_TYPES = {
	SPACING: {
		mx: { description: 'margin-left & margin-right', control: { type: 'number' } },
		my: { description: 'margin-top & margin-bottom', control: { type: 'number' } },
		...
		px: { description: 'padding-left & padding-right', control: { type: 'number' } },
		py: { description: 'padding-top & padding-bottom', control: { type: 'number' } },
